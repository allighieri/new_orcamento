            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('budgets.store') }}" method="POST" id="budgetForm">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-1">
                                                            ...
                                                            <div class="d-flex gap-1 align-items-end" style="height: 38px;">
                                                                <button type="button" class="btn btn-danger btn-sm remove-product" style="height: 38px;">
                                                                    <i class="bi bi-trash3"></i>
                                                                </button>
                                                                <button type="button" class="btn btn-success btn-sm add-product" style="height: 38px;">
                        ...
                        <div class="card mt-4 mb-5" id="remainingAmountCard" style="border-left: 4px solid #28a745; display: none;">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="d-flex justify-content-between align-items-center">
...
<!-- Modal Calculadora de Preço Unitário -->
